...
namespace Reallukee.GWC
{
    internal class Program
    {
        ...
        static float cvr = 1.2f;
        static float cvg = 0.8f;
        static float cvb = 1.6f;
        ...
        static void Render(Canvas canvas, Window window)
        {
            ...
            canvas.FillColor = Color.FromArgb(255, (int)cr, (int)cg, (int)cb);
            canvas.BorderColor = Color.FromArgb(255, (int)cr, (int)cg, (int)cb);
